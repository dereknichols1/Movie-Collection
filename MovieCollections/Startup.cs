...
using MovieCollections.DataAccess.Data.Repository;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ApplicationDbContext>(options =>
                    ...
                    sqlServerOptions => sqlServerOptions.MigrationsAssembly("MovieCollections.DataAccess")
                    ));
